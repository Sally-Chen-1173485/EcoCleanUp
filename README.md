...
# AI acknowledgment
1. I have used ChatGPT to create the data to be populated into the database. I asked the ChatGPT to create real names, and emails and event details. After the AI created the data, I have reviewed and changed some of the data that to make sure I have the event data I wanted. 
2. I used Github copilot to create the sytle.css file to modify the page colour and style that I wanted to be. However, I intially wanted black and dard blue colour theme but the creation by the AI does not quite fit my expectation so i have changed black background to white and also changed some of the colour class as I iterate the webapp.
3. I have asked to Github copilot to "modify the webpage settings to fit for mobile adoption". 
